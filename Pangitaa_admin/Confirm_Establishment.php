<?php
	...
	if(mysqli_query($con, "Update establishment set verified = true where esh_id = '$estab_id'"))
	{
		...
		$result = mysqli_query($con,$sql);
			...
			while($row=mysqli_fetch_array($result))
			{
				...
				$message = "Greetings from Pangitaa!! \n We would like to inform you that your request has been verified for '.$bus_name.' establishment.";
				$to = $row[0];
